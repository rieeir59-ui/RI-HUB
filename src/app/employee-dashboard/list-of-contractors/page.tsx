...
const initialRow: Omit<ContractorRow, 'id'> = {
...
export default function ListOfContractorsPage() {
    ...
    const handleRowChange = (id: number, field: keyof ContractorRow, value: string) => {
    ...
    const handleDownloadPdf = () => {
        ...
        doc.text('LIST OF CONTRACTORS', doc.internal.pageSize.getWidth() / 2, yPos, { align: 'center' });
        yPos += 15;
        ...
        const toLines = doc.splitTextToSize(toContractor, 85);
        doc.text(toLines, 16, yPos + 5);
        yPos += 35;
        
        const note = "List Subcontractors and others proposed to be employed on the above Project as required by the bidding documents.\n(To be filled out by the Contractor and returned to the Architect.)";
        ...
        doc.save('list-of-contractors.pdf');
    ...
    return (
        <div className="space-y-8">
            <DashboardPageHeader
                ...
                description="Manage the list of contractors and subcontractors."
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-center font-headline text-3xl text-primary">List of Contractors</CardTitle>
                </CardHeader>
                <CardContent className="p-4 md:p-6">
                    <form className="space-y-4 mb-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                           ...
                           <div>
                                <Label htmlFor="to_contractor">To: (Contractor)</Label>
                                <Textarea id="to_contractor" rows={3} value={toContractor} onChange={e => setToContractor(e.target.value)} />
                           </div>
                        </div>
                    </form>
                    
                    <p className="text-sm text-muted-foreground my-4">List Subcontractors and others proposed to be employed on the above Project as required by the bidding documents. (To be filled out by the Contractor and returned to the Architect.)</p>
