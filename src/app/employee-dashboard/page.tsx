...
import { CheckCircle2, Clock, XCircle, Loader2, Briefcase, PlusCircle, Trash2, Save, Download } from 'lucide-react';
                        ...
                        <TableBody>
                            {rows.map(row => (
                                <TableRow key={row.id}>
                                    ...
                                    <TableCell>
                                        <Select value={row.status} onValueChange={(val: Project['status']) => handleRowChange(row.id, 'status', val)}>
                                            <SelectTrigger className="w-[180px]">
                                               <div className="flex items-center gap-2">
