...
const initialProjectRows: ProjectRow[] = [
    { id: 1, srNo: '1', projectName: 'Nawaz sharif Business Hub', area: '25 Kanals', projectHolder: 'ASAD/ WALEED/ Jabbar', allocationDate: '', siteSurveyStart: '', siteSurveyEnd: '', contactStart: '', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '', proposalEnd: '', threedStart: '', threedEnd: '', architecturalDrawingsStart: '', architecturalDrawingsEnd: '', mepDrawingsStart: '', mepDrawingsEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '', remarks: '' },
    { id: 2, srNo: '2', projectName: 'C-B-D', area: '', projectHolder: 'ASAD/ WALEED', allocationDate: '16-Jun-25', siteSurveyStart: '', siteSurveyEnd: '', contactStart: '16-Jun-25', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '16-Jun-25', proposalEnd: '', threedStart: '', threedEnd: '', architecturalDrawingsStart: '', architecturalDrawingsEnd: '', mepDrawingsStart: '', mepDrawingsEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '', remarks: '' },
];

const initialStatusRows: StatusRow[] = [
    { id: 1, title: '1. Nawaz sharif Business Hub', status: 'Project Started' },
    { id: 2, title: '2. C-B-D', status: 'final drawings has been sent only animation need to amend and resend.' },
];
