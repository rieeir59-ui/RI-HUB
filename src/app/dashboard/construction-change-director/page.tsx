...
export default function Page() {
    ...
    const handleSave = () => {
        ...
        const dataToSave = {
            ...
            projectName: recordName || 'Untitled Change Directive',
            data: {
        ...
        addDoc(collection(firestore, 'savedRecords'), dataToSave)
            .then(() => {
                toast({ title: 'Record Saved', description: 'The change directive has been saved.' });
                setIsSaveOpen(false);
            })
            .catch(serverError => {
  ...
  return (
    <div className="space-y-8">
      <DashboardPageHeader
        ...
        description="Create and track construction change directives."
      ...
      <Card>
        ...
        <CardContent className="p-4 md:p-6">
            <form className="space-y-6">
                ...
                <div>
                    <Label htmlFor="description">You are hereby directed to make the following change(s) in this Contract:</Label>
