...
export const employees: Employee[] = [
  ...
  { name: 'Waqas Rasool', contact: '123-456-7890', email: 'waqas.rasool@ri-hub.com', record: 'EMP-006', avatarId: 'avatar-2', department: 'finance', password: 'password@6' },
  ...
  { name: 'Mohsin', contact: '123-456-7890', email: 'mohsin@ri-hub.com', record: 'EMP-009', avatarId: 'avatar-2', department: '3d-visualizer', password: 'password@9' },
