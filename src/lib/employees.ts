...
export const employees: Employee[] = [
  ...
  { name: 'Sobia', contact: '123-456-7890', email: 'sobia@ri-hub.com', record: 'EMP-002', avatarId: 'avatar-3', department: 'admin', password: 'password123' },
  ...
  { name: 'Waqas Rasool', contact: '123-456-7890', email: 'waqas.rasool@ri-hub.com', record: 'EMP-006', avatarId: 'avatar-2', department: 'finance', password: 'password123' },
